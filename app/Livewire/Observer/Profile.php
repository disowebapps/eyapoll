...
class Profile extends Component
{
    ...
    public function updatedProfileImage()
    {
        ...
        Auth::guard('observer')->setUser($user->fresh());
    ...
    public function updateProfile()
    {
        $this->validate([
            ...
            'email' => 'required|email|max:255|unique:observers,email,' . Auth::guard('observer')->id(),
            'phone_number' => 'required|string|max:20',
        ]);

        Auth::guard('observer')->user()->update([
    ...
    public function updatePassword()
    {
        ...
        if (!Hash::check($this->current_password, Auth::guard('observer')->user()->password)) {
    ...
    {
        return view('livewire.observer.profile')->layout('layouts.observer');
    }
}